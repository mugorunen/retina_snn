...
class ThreeETplus_Eyetracking(Dataset):
    ...
    def __init__(
        ...
        if dataset == "t":
            ...
            if split == "train":
                filenames = self.load_filenames(os.path.join(data_list_dir, "t_v.txt"))
            elif split == "val":
                filenames = self.load_filenames(os.path.join(data_list_dir, "test_files.txt"))
            elif split == "test":
                filenames = self.load_filenames(os.path.join(data_list_dir, "test_files.txt"))
            ...
            # pdb.set_trace()
            if split == "train":
                filenames = self.load_filenames(os.path.join(data_list_dir, "t_v_t.txt"))
            elif split == "val":
                filenames = self.load_filenames(os.path.join(data_list_dir, "val_files.txt"))
            elif split == "test":
                filenames = self.load_filenames(os.path.join(data_list_dir, "test_files.txt"))
